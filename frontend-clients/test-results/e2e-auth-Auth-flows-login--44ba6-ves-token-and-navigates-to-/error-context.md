...
- Name: e2e/auth.spec.ts >> Auth flows >> /login?token= saves token and navigates to /
...
Call log:
  - navigating to "/login?token=eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJyb2xlIjoiY3VzdG9tZXIiLCJleHAiOjQxMDI0NDQ4MDB9.fake-sig&id=1&role=customer", waiting until "load"
