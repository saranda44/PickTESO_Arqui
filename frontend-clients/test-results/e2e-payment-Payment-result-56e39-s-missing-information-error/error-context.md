...
- Name: e2e/payment.spec.ts >> Payment result – payment confirmation >> missing params shows missing information error
- Location: e2e/payment.spec.ts:45:7
...
Call log:
  - navigating to "/payment/result", waiting until "load"
