...
- Name: e2e/payment.spec.ts >> Payment result – payment confirmation >> failed payment shows error message and back button
- Location: e2e/payment.spec.ts:30:7
...
Call log:
  - navigating to "/payment/result?session_id=sess_bad&order_id=99", waiting until "load"
